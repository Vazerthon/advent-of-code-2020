...
const instructionStrategies = {
  ...
  acc: (index, operator, value, accumulator) => [index + 1, mathStrategies[operator](accumulator, value)],
  jmp: (index, operator, value, accumulator) => [mathStrategies[operator](index, value) , accumulator],
};
